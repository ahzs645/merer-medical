    ...
    async import(bytes, opts) {
      ...
      await db.transaction(
        ...
        [
          ...
          db.clinical_demo_sources,
          db.source_code_systems,
          db.dental_terminology_sets,
          db.dental_terminology_codes,
          db.dental_provider_records,
          db.dental_patient_profiles,
          db.dental_tooth_charts,
          db.dental_procedure_records,
          db.dental_insurance_records,
          db.dental_claim_records,
          db.dental_recall_records,
          db.dental_ortho_records,
          db.dental_tooth_condition_records,
          db.dental_perio_exams,
          db.dental_treatment_plans,
          db.dental_fee_schedules,
          db.dental_imaging_records,
          db.dental_lab_cases,
          db.dental_form_records,
          db.attachments,
          db.attachment_blobs,
          db.instance_config,
