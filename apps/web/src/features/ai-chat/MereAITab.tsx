      ...
      if (!isLoadingAiResponse && vectorStorage) {
        ...
        try {
          const result = await performRAGRequest({
            ...
            openMedEnabled: experimental__openmed_enabled,
            openMedEndpoint: experimental__openmed_endpoint,
            openMedDeidentifyCloudAi: experimental__openmed_deidentify_cloud_ai,
            db,
            user,
            vectorStorage,
