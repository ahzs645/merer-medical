...
import { useImmunizationData } from './useImmunizationData';
...
/**
 * Deleting a dose from the timeline used to leave the deleted row on screen
 * until the page was reloaded, because this hook only refetched on db/user
 * changes.
 */
describe('useImmunizationData', () => {
  it('refetches when a record is added, edited, or deleted', async () => {
    const { result } = renderHook(() => useImmunizationData());
