      ...
      <div className="border-b border-gray-200 px-3 py-3 sm:px-5 sm:py-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
          <div>
            ...
            {/* Undated rows are listed, not dropped, so say so rather than
                leaving the reader to wonder why a result has no date. */}
            {coverage.undatedLabRows > 0 ? (
              <p className="mt-1 text-sm text-gray-600">
                {coverage.undatedLabRows} lab results arrived without a
                collection date. They are listed last and show their date as
                Unknown.
              </p>
            ) : null}
          </div>
