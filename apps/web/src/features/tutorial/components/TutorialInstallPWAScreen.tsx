      ...
      {isSafari() && (
        <>
          <h1 className="mb-2 text-center text-xl font-semibold">
            {t("We see you're using an Apple device")}
          </h1>
          <div className="mb-4">
            {isMobileDevice() ? (
              <p className="text-center">
                {t('For the best experience, you should')}{' '}
                <b>{t('install Mere as an app')}</b> {t('on your homescreen.')}
              </p>
            ) : (
              <p className="text-center">
                {t('For the best experience, you should')}{' '}
                <b>{t('install Mere as an app')}</b> {t('on your computer.')}
              </p>
            )}
            {isSafari() ? (
      ...
      {isChrome() && (
        <>
          <h1 className="mb-2 text-center text-xl font-semibold">
            {isMobileDevice()
              ? t('Install the App')
              : t('Install the Mere App on your Computer')}
          </h1>
          <div className="mb-4">
            {isMobileDevice() ? (
              <p className="text-center">
      ...
      {isFirefox() && (
        <>
          ...
          <div className="mx-auto mb-4 self-center justify-self-center rounded-lg p-2 align-middle sm:max-w-lg">
            <p className="mb-2">
              {t('Unfortunately, Firefox does not support installing PWAs.')}
            </p>
            <p className="mb-2">
              {t('You can')}{' '}
              <a
              ...
              {t('to add support for installing PWAs like Mere.')}
            </p>
          </div>
        </>
      )}
