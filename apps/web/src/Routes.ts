export enum Routes {
  ...
  DocumentDetail = '/records/documents/detail/:documentId',
  ...
  OptometrySurgery = '/records/optometry/surgery',
  OptometryImaging = '/records/optometry/imaging',
  OptometryRecords = '/records/optometry/records',
