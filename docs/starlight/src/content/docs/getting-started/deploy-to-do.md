---
title: "1-Click Deploy to Digital Ocean"
...
Go to [this guide](/docs/getting-started/onpatient-setup) to see how to get those values and learn more. If you don't need OnPatient integration, feel free to leave those variables blank.
