---
title: "Run with Docker or Docker Compose"
...
```nginx title="mere-medical/nginx/conf/nginx.conf"
server {
...
To get the env variables needed for OnPatient functionality, [see our documentation here](/docs/getting-started/onpatient-setup).
...
| `ONPATIENT_CLIENT_ID` | No | Client ID for OnPatient/DrChrono | See [OnPatient setup](/docs/getting-started/onpatient-setup) |
| `ONPATIENT_CLIENT_SECRET` | No | Client secret for OnPatient/DrChrono | See [OnPatient setup](/docs/getting-started/onpatient-setup) |
| `EPIC_CLIENT_ID_R4` | No | Client ID for Epic MyChart production (recommended) | See [Epic setup](/docs/getting-started/epic-setup) |
| `EPIC_SANDBOX_CLIENT_ID_R4` | No | Client ID for Epic MyChart sandbox (recommended) | See [Epic setup](/docs/getting-started/epic-setup) |
| `EPIC_CLIENT_ID` | No | Client ID for Epic MyChart production (legacy DSTU2, for backwards compatibility) | See [Epic setup](/docs/getting-started/epic-setup) |
| `EPIC_CLIENT_ID_DSTU2` | No | Client ID for Epic MyChart production (legacy DSTU2) | See [Epic setup](/docs/getting-started/epic-setup) |
| `EPIC_SANDBOX_CLIENT_ID` | No | Client ID for Epic MyChart sandbox (legacy DSTU2, for backwards compatibility) | See [Epic setup](/docs/getting-started/epic-setup) |
| `EPIC_SANDBOX_CLIENT_ID_DSTU2` | No | Client ID for Epic MyChart sandbox (legacy DSTU2) | See [Epic setup](/docs/getting-started/epic-setup) |
| `CERNER_CLIENT_ID` | No | Client ID for Cerner Health (supports both R4 and DSTU2) | See [Cerner setup](/docs/getting-started/cerner-setup) |
...
| `HEALOW_CLIENT_ID` | No | Client ID for Healow (eClinicalWorks) | See [Healow setup](/docs/getting-started/healow-setup) |
| `HEALOW_CLIENT_SECRET` | No | Client secret for Healow confidential client (enables refresh tokens) | See [Healow setup](/docs/getting-started/healow-setup) |
