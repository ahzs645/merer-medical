...
<div className="flex-col sm:flex-row flex w-full">
    <div style={{"margin": "4px"}}>
        ...
        <video width="100%" height="auto" style={{"margin": "0px"}} controls>
            <source src="/docs/vid/ExactSearch.mp4" type="video/mp4" alt="Exact search demo"/>
    ...
    <div style={{"margin": "4px"}}>
        ...
        <video width="100%" height="auto" style={{"margin": "0px"}} controls>
            <source src="/docs/vid/SemanticSearch.mp4" type="video/mp4" alt="Semantic search demo"/>
            Your browser does not support the video tag.
        </video>
    </div>
</div>
...
<div className="flex w-full">
        <video width="100%" height="auto" style={{"margin": "0px"}} controls>
            <source src="/docs/vid/DoIHaveAnemiaDemo.mp4" type="video/mp4" alt="Q&A demo"/>
            Your browser does not support the video tag.
        </video>
</div>
