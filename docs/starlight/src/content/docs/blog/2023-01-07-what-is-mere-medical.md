...
description: "Mere Medical documentation: What is Mere Medical?"
---
...
<video style={{"margin": "0px"}} controls width="100%">
  ...
  <source src="/docs/vid/timeline.webm" type="video/webm"/>
</video>

Clicking on the summary tab will give you an overview about your health.
<video style={{"margin": "0px"}} controls width="100%">

  <source src="/docs/vid/search.webm" type="video/webm"/>
</video>
...
<video style={{"margin": "0px"}} controls width="100%">
  ...
  <source src="/docs/vid/add-connection.webm" type="video/webm"/>
</video>

Mere supports connecting to multiple sources all at once
<video style={{"margin": "0px"}} controls width="100%">

  <source src="/docs/vid/multiple-connections.webm" type="video/webm"/>
</video>

Your data is yours - you can back up and export your data to JSON at any point.
<video style={{"margin": "0px"}} controls width="100%">

  <source src="/docs/vid/settings-and-export.webm" type="video/webm"/>
</video>
